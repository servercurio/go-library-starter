...
- `docs/` — Non-Go documentation assets. `logo.svg` is the full Server Curio logo, embedded at the top of the README; `logo-mark.svg` is the SC mark only, for square and small-format uses. Neither is consumed by any Go code.
