...
// Default is the package-wide structured logger. It is swapped in by
// Initialize and is safe to read concurrently once Initialize has returned.
...
func Initialize(c *Config) {
	...
	Default = newLogger(c.Default, os.Stdout)
}
